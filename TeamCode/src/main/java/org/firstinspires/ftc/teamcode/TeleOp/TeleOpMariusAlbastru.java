...
//
                    xReal = - (Math.tan(Math.toRadians(limeLight.getTargetTx())) * (((double) 11.2 /384) * lift.getPosition())+7.5);
                    yReal = - (Math.tan(Math.toRadians(limeLight.getTargetTy())) * (((double) 12.2/384) * lift.getPosition())+7.5);
